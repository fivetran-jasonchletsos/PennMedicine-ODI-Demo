...
export default function WizardLivePage() {
  ...
  useEffect(() => {
    let cancelled = false;
    const getJson = (name: string) => fetch(wizardDataUrl(name)).then(r => {
      if (!r.ok) throw new Error(`${name}: ${r.status}`);
      return r.json();
    });
    Promise.all([
      getJson('agents.json'),
      getJson('scenario.json'),
      getJson('build_script.json'),
    ]).then(([a, s, b]) => {
      if (cancelled) return;
      setAgents(a.agents ?? []);
      setScenario(s);
      setEvents(b.events ?? []);
    }).catch(() => { /* leave on the loading-playback state rather than crash */ });
    ...
    <div className="wizard-terminal mx-auto max-w-[1640px] px-4 py-4 sm:px-6 lg:px-8">
      ...
      <div
        ...
        style={{
          ...
          borderLeft: '4px solid var(--clinical-teal)',
        ...
        <div className="flex items-center gap-3 flex-wrap">
          <span
            ...
            style={{
              ...
              background: 'rgba(13,148,136,0.1)', color: 'var(--clinical-teal)', border: '1px solid rgba(13,148,136,0.35)',
            }}
          >
            <span
              style={{
          ...
          <span className="font-mono" style={{ color: 'var(--ink-muted)', fontSize: 13 }}>
            Step{' '}
            <span style={{ color: 'var(--clinical-teal)', fontWeight: 700 }}>{currentStep}/{totalSteps}</span>
          ...
          >
            <div
              style={{
                ...
                height: '100%',
                background: complete ? 'var(--clinical-green)' : 'var(--clinical-teal)',
      ...
      <div
        ...
        style={{ borderLeftColor: 'var(--clinical-teal)' }}
      >
        <div className="min-w-0 flex-shrink" style={{ flex: '1 1 460px' }}>
          <div className="eyebrow" style={{ fontSize: 10, marginBottom: 2, color: 'var(--clinical-teal)' }}>
            Quality &amp; Patient Safety · {scenario.timezone_label} · {scenario.requested_by}
          </div>
          <p
        ...
        <div className="font-mono text-[var(--ink-muted)] shrink-0" style={{ fontSize: 11 }}>
          Target: <span style={{ color: 'var(--clinical-teal)', fontWeight: 700 }}>{scenario.metric_code}</span>
        </div>
      </div>
            ...
            <div
              ...
              style={{
                ...
                background: active
                  ...
                  : done
                  ? 'var(--clinical-green-bg, rgba(20,94,54,0.06))'
                  : 'var(--paper-deep)',
              }}
              title={`${s.who} · ${s.tools}`}
            >
              <div
                ...
                style={{
                  ...
                  color: active ? 'var(--clinical-teal)' : done ? 'var(--clinical-green)' : 'var(--ink-soft)',
                }}
              >
      ...
      >
        ...
        <section
          className="clinical-card flex flex-col min-h-[60vh] lg:min-h-[300px] lg:h-[calc(100dvh-440px)]"
        >
          <header
                      ...
                      <div className="flex items-center gap-2 flex-wrap mb-1.5">
                        ...
                        <span
                          ...
                          style={{
                            ...
                            background: 'rgba(13,148,136,0.10)', color: 'var(--clinical-teal)',
        ...
        <section className="flex flex-col gap-3 min-h-[60vh] lg:min-h-[300px] lg:h-[calc(100dvh-440px)]" style={{ minWidth: 0 }}>
            ...
            >
              <div className="flex items-center gap-3 flex-wrap min-w-0">
                <div className="eyebrow font-mono" style={{ fontSize: 11, letterSpacing: '0.02em' }}>
                  models/gold/fct_sepsis_bundle_by_service_line_daily.sql
                </div>
                <span
          ...
          <div className="clinical-card flex flex-col" style={{ flex: '1 1 0', minHeight: 0 }}>
            ...
            >
              <div className="flex items-center gap-3 flex-wrap min-w-0">
                <div className="eyebrow font-mono" style={{ fontSize: 11, letterSpacing: '0.02em' }}>
                  models/gold/fct_sepsis_bundle_by_service_line_daily.yml
                </div>
                <span
                  className="layer-chip"
                  style={{
      ...
      <div className="clinical-card mt-2 px-3 py-2 flex items-center gap-3">
              ...
              >
                <span
                  style={{
                    ...
                    background: i === 0 ? 'var(--clinical-teal)' : 'var(--ink-soft)',
      ...
      {complete && (
        <div
          ...
          style={{
            borderLeft: '5px solid var(--clinical-green)',
            background: 'var(--clinical-green-bg, rgba(20,94,54,0.06))',
          }}
        >
            ...
            <div className="flex items-baseline gap-3 flex-wrap">
              <div
                ...
                style={{
                  ...
                  background: 'rgba(20,94,54,0.12)', color: 'var(--clinical-green)',
      ...
      <style>{`
        ...
        .wizard-terminal [style*="color: var(--clinical-teal)"] { color: var(--t-accent) !important; }
        ...
        .wizard-terminal .clinical-card[style*="rgba(13,148,136"] {
        ...
        .wizard-chat-cursor::after {
          ...
          margin-left: 2px;
          color: var(--clinical-teal, #0d9488);
