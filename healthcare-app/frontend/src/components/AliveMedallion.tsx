      ...
      <div className="am-grid">
        ...
        <section className="am-zone am-zone-sources">
          ...
          <footer className="am-zone-footer">
            ...
            <span>CDC + batch via Fivetran <span style={{ color: '#9ca3af' }}>·</span> 78% no-op syncs <span style={{ color: '#9ca3af' }}>·</span> HL7 streams via Kinesis</span>
          </footer>
        </section>
        ...
        <section className="am-zone am-zone-consumers">
          ...
          <div className="am-hipaa-band">
            ...
            <span className="am-hipaa-detail">HIPAA · row-level access · column masking</span>
          </div>
    ...
    case 'epic_clarity':
      return (
        <svg {...common}>
          ...
          <text x="12" y="15.5" textAnchor="middle" fontSize="4.4" fontWeight="800" fill="#ffffff" letterSpacing="0.1" fontFamily="Helvetica, Arial, sans-serif">EPIC CLARITY</text>
        </svg>
      );
    case 'sqlserver':
      return (
