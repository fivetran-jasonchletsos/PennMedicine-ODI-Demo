...
fct_account_summary as (
    select
        ...
        admission_date,
        discharge_date,
        extract(year from CAST(admission_date AS date))     as admission_year,
        extract(month from CAST(admission_date AS date))    as admission_month,
        extract(quarter from CAST(admission_date AS date))  as admission_quarter,
        copay_amount,
        deductible_amount,
        disallowed_amount,
